...
class Shortener(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if "longuri" not in params or "shortname" not in params:
            ...
            # self.send_header('Content-type', 'text/plain; charset=utf-8')
            self.wfile.write('You need give the longuri and its shortname'.encode())
        ...
        if CheckURI(longuri):
            ...
            #    Delete the following line.
            self.send_response(404)
            # self.send_header('Content-type', 'text/plain; charset=utf-8') # 少了这一行也行
            self.wfile.write("The website you request doesn't exit".encode())
